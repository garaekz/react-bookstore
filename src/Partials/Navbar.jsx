      ...
      <header className="py-[15px] lg:py-0 fixed h-20 inset-x-0 top-0 bg-white z-30 flex items-center">
        ...
        <div className="px-[15px] h-full w-full md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto flex items-center">
          <div className="flex items-center w-full">
            <div>
              <Link to={"/"}>
                <img src={reactLogo} alt="React Logo" className="block max-h-[35px] h-auto" />
              </Link>
            </div>
              ...
              >
                ...
                <ul className="block h-full overflow-y-auto m-0 lg:flex lg:items-center lg:flex-wrap lg:justify-center lg:p-0">
                  <li className="translate-y-0 transition-all duration-300 opacity-100 my-[10px] lg:my-0 lg:mx-[24px] lg:relative lg:text-body">
                    <Link
                      to={"/"}
                      className={`${pathname === '/' ? 'before:w-full before:opacity-1':'before:w-0 before:opacity-0'} text-body lg:text-heading lg:h-[80px] lg:leading-[80px] lg:block h-auto py-[5px] lg:p-0 inline-block font-bold relative duration-300 before:h-[2px] before:bg-black before:absolute before:bottom-[29px] before:left-0 before:transition-all before:duration-500 hover:before:w-full hover:before:opacity-100`}
                    >
                      Home
                    </Link>
                  </li>
                  <li className="translate-y-0 transition-all duration-300 opacity-100 my-[10px] lg:my-0 lg:mx-[24px] lg:relative lg:text-body">
                    <Link
                      to={"/shop"}
                      className={`${pathname === '/shop' ? 'before:w-full before:opacity-1':'before:w-0 before:opacity-0'} text-body lg:text-heading lg:h-[80px] lg:leading-[80px] lg:block h-auto py-[5px] lg:p-0 inline-block font-bold relative duration-300 before:h-[2px] before:bg-black before:absolute before:bottom-[29px] before:left-0 before:transition-all before:duration-500 hover:before:w-full hover:before:opacity-100`}
                    >
                      Shop
                    </Link>
